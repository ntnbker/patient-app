...
class DashBoard extends Component {
  ...
  _handleKeyPress(event) {
    ...
    if (keyCode == '13'){
      return this._handleFindPatient()
    }
  }
        ...
        <div className="app-dashboard">
          <div className="dashboard-search">
            <div className="row">
              ...
              <div className="col-sm-3 col-sx-12">
                <input 
                  type="text" 
                  className="form-control" 
                  id='hospital' 
              ...
              <div className="col-sm-1 col-sx-12 btn btn-primary" style={{margin: '0 10px'}} onClick={this._handleFindPatient.bind(this)}>
                  <i className="fa fa-search"></i>
                  &nbsp;
                  Find
              </div>
              <div className="col-sm-1 col-sx-12 btn btn-primary" style={{margin: '0 10px'}} onClick={this._handleViewProfile.bind(this)}>
                  My Profile
              </div>
              <div className="col-sm-1 col-sx-12 btn btn-primary" style={{margin: '0 10px'}} onClick={this._handleLogout.bind(this)}>
                  Logout
              </div>
            </div>
          </div>
